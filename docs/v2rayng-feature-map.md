...
| Persistent app settings | Present for core VPN, DNS, IPv6, mux/XUDP/fragment, sniffing, log and routing strategy; selected values are applied at connection start, including VPN interface DNS, IPv6 routing, outbound Happy Eyeballs, mux settings, and outbound fragment settings. |
